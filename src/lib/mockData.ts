...
export const INITIAL_PRODUCTS: ProductType[] = [
  ...
  },
  {
    ...
    moq: 3,
    basePrice: 11500.0,
    image: "https://www.jcb.com/content/dam/jcb/products/backhoe-loaders/3dx/3dx-banner.jpg",
  ...
  },
  {
    ...
    moq: 6,
    basePrice: 5400.0,
    image: "https://commons.wikimedia.org/wiki/Special:Redirect/file/Sonalika_Baagban_DI-30Rx_Tractor_Left_Front_Coorg_Feb24_A7C_09555.jpg",
