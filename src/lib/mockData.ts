...
export const INITIAL_PRODUCTS: ProductType[] = [
  ...
  },
  {
    ...
    moq: 5,
    basePrice: 6800.0,
    image: "https://suprabhatagroindustries.in/wp-content/uploads/2026/08/mahindra-fiber-hood-image.png",
  ...
  },
  {
    ...
    moq: 3,
    basePrice: 11500.0,
    image: "https://suprabhatagroindustries.in/wp-content/uploads/2026/08/john-deere-fiber-hood-image.png",
  ...
  },
  {
    ...
    moq: 6,
    basePrice: 5400.0,
    image: "https://suprabhatagroindustries.in/wp-content/uploads/2026/08/swaraj-fiber-hood-image.png",
...
export const INITIAL_QUOTATIONS: QuotationType[] = [
  {
    ...
    paymentTerms: "50% Advance with Purchase Confirmation, 50% prior to dispatch.",
    deliveryTerms: "Ex-Factory, Uran Islampur (Sangli, Maharashtra). Heavy-gauge wooden pallet packing included.",
    notes: "Commercial quotation formulated as per technical specs verified by S Patil.",
    createdBy: "Rahul Deshmukh (Sales Head)",
...
export const INITIAL_ORDERS: OrderType[] = [
  {
    ...
    statusHistory: [
      ...
      },
      {
        status: "PACKED",
        changedBy: "Vikas Shinde (Warehouse Manager)",
        note: "Packed on reinforced pallets with edge protectors. Ready for VRL Logistics pickup.",
  ...
  },
  {
    ...
    dispatchDate: "2026-08-23T14:00:00Z",
    estimatedDelivery: "2026-08-25T18:00:00Z",
    ...
    statusHistory: [
      ...
      },
      {
        ...
        note: "Delivery confirmed at Kolhapur warehouse with gate receipt.",
...
export const INITIAL_STOCK_MOVEMENTS: StockMovementType[] = [
  {
    ...
    quantity: 50,
    referenceId: "PO-8910-FACTORY",
    performedBy: "Vikas Shinde",
    note: "Batch manufacturing lot received from press shop.",
  ...
  },
  {
    ...
    performedBy: "System (Atomic Quote Acceptance)",
    note: "Reserved 10 units for ABC Auto Spares order.",
    createdAt: "2026-08-26T09:00:00Z",
  },
  {
    id: "mov-3",
    ...
    quantity: -6,
    referenceId: "ORD-2026-0038",
    performedBy: "Vikas Shinde",
    note: "Dispatched for DTDC Express pickup.",
